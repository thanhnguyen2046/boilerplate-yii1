...
class ProductController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Product'])) {
            ...
            // trigger event
            $model->onNewProduct = array($this, 'sendEmail');
...
//        }
        ...
        if ($this->_model === null) {
            if (isset($_GET['id'])) {
                if (Yii::app()->user->isGuest) {
                    $condition = 'status=' . Product::STATUS_PUBLISHED . ' OR status=' . Product::STATUS_ARCHIVED;
                } else {
                    $condition = '';
                }
                $this->_model = Product::model()->findByPk($_GET['id'], $condition);
            }
            if ($this->_model === null) {
    ...
    public function sendEmail($event)
    {
        ...
        var_dump($product->title, $product->content);
    }
